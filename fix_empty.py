...
<body class="bg-gray-50 text-gray-900">
    <nav class="fixed w-full z-[100] top-0 bg-white border-b border-gray-200">
        ...
        <div id="mobile-menu" class="hidden absolute w-full bg-white border-b border-gray-200 shadow-xl p-6 font-bold text-sm uppercase grid grid-cols-1 gap-4 z-[99]">
            ...
            <a href="/about.html" class="hover:text-teal-500">About</a>
            <a href="/blog.html" class="hover:text-teal-500">Blog</a>
        </div>
    </nav>
    <main class="pt-32 min-h-screen max-w-7xl mx-auto px-6">
        <h1 class="text-4xl font-black">Coming Soon</h1>
        <p class="mt-4 text-gray-600">This page is currently being updated.</p>
    </main>
    <footer class="py-16 bg-white border-t border-gray-200 text-center text-xs text-gray-400">
        <p class="font-black text-xl text-slate-900 mb-2">made<span class="text-teal-500">real</span></p>
        <p>© 2026 MadeReal Design Ltd. Lancashire</p>
    </footer>
    <script>
